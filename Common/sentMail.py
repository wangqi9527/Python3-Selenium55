...
def sent_mail():
    try:
        ...
        message['Subject'] = rq + "兰州电网PC端部分功能自动化测试报告.html"  # 邮件的主题，也可以说是标题

        # 邮件正文内容
        message.attach(MIMEText('附件为兰州电网PC端部分功能自动化测试报告.html', 'plain', 'utf-8'))
        ...
        att1.add_header("Content-Disposition", "attachment", filename=("gbk", "", "兰州电网PC端部分功能自动化测试报告.html"))
        # 附件名称非中文时的写法
